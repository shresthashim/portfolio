...
import { SiJavascript, SiTailwindcss, SiNextdotjs, SiExpress, SiPostgresql, SiMysql, SiGraphql, SiCanva, SiFigma, SiWordpress, SiLinux } from "react-icons/si";
...
const ExperienceDetails: React.FC<ExperienceDetailsProps> = ({ icon, name, level }) => (
  <article className={styles.experience_details}>
    <BsPatchCheckFill className={styles.experience_detailsIcon} />
    <div>
      ...
      <div className={`container ${styles.experience_container}`}>
        ...
        <div className={styles.experience_frontend}>
          ...
          <div className={styles.experience_content}>
            ...
            <ExperienceDetails icon={<BsFillBootstrapFill style={{ marginRight: "5px" }} />} name="Bootstrap" level="Experienced" />
